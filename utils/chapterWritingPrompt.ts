...
3. **网文特化"Show vs Tell"原则：**
   - ✅ "Tell"（直接说明）：修炼过程、系统说明、等级设定、境界突破必须直接告知，保持网文节奏流畅
   - ✅ "Show"（展现描写）：装逼打脸、情感爆发、战斗场面时才需要生动展现
...
5. **网文爽点节奏（强制爽文逻辑）：**
   ...
   - 装逼-打脸-反转的经典节奏
   - **主角憋屈不能超过3章**：必须有反击（报仇不隔夜）
   - **期待感管理**：明确告诉读者主角即将获得什么好处
   - 章末悬念，让读者欲罢不能
...
**目标指标：**
- 章节长度：{{target_length}} 字（网文黄金字数：2000-3000字，利于全勤奖）
