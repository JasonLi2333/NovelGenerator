...
正确输出的强制示例：
✅ 正确："她推开茶楼的门。[DESCRIPTION_LOBBY_ATMOSPHERE] 掌柜的笑容过于热情。[DIALOGUE_RECEPTIONIST_GREETING] 一阵寒意在她胃里蔓延。[INTERNAL_SHIMEI_UNEASE] 还没来得及转身离开，身后响起了脚步声。[ACTION_APPROACH]"

❌ 绝对错误："*开场 - 强度：5/10* 角色进入宗门大殿。[DESCRIPTION_LOBBY_ATMOSPHERE]"
❌ 绝对错误："以下是第2章的结构框架..."
❌ 绝对错误："**章节标题** *强度标记* 结构元素"
...
**结构示例：**
"他推开宗门大殿的门。[DESCRIPTION_HALL_ATMOSPHERE] 掌门的反应很迅速。[DIALOGUE_PALM_GREETING] 他的态度有些不对劲。[INTERNAL_HERO_SUSPICION]
...
**有潜台词的对话：**
每句话都应承载超越字面意义的分量。角色在多层次说话 - 他们说的、他们的意思、他们隐藏的。特别强调"话里有话"（潜台词）和"身份压制"。

示例：
"你也配？"她轻声说，话语中带着明显的身份压制。
"我只是想为宗门出力，"他低头回答，潜台词是"我不敢得罪你"。
"出力？就你这点修为，也配谈出力？"
他的笑容没到达眼底。"圣女教训的是，我一定铭记于心。"
...
**情感复杂性：**
角色应包含矛盾。英雄有缺陷，反派有动机，每个人都为选择付出代价。特别强调"身份压制"场景中的复杂情感。

核心原则：
- 每句对话都必须有潜台词 - 角色很少说出本意，擅长"话里有话"
- 通过矛盾和意外反应展示角色复杂性
- 使用自然语言模式 - 人们会打断、犹豫、误解
- 情感真实性优于文学美感，擅长身份压制与被压制的情感冲突
- 每个角色有独特的声音和说话模式，在网文中体现修仙/都市装逼风格
...
[DIALOGUE_PALM_GREETING]: "你来早了，"掌门头也不抬地说，手里还在把玩玉简。他的语气暗示早到不一定是好事。

[INTERNAL_HERO_SUSPICION]: 有什么不对劲。也许是掌门不肯抬头的样子，也许是她一进门他肩膀就绷紧了。又或者她只是太多疑了。天，她真希望只是自己多想。

[DIALOGUE_CONFRONTATION]: "我们得谈谈，"她说，声音低沉但坚定。"你也配？"

**错误示例（不要这样做）：**

❌ 以下是对话槽位：
1. [DIALOGUE_GREETING] - 掌门问候她
...
示例：
灵气如薄雾般萦绕在洞天福地中，带着清新的草木香和隐约的杀机。洞壁上，灵石闪烁着柔和的光芒，映照出嶙峋的石钟乳。远处的灵泉潺潺作响，水中灵鱼游弋，偶尔跃起溅起晶莹的水花，空气中弥漫着浓郁的天地灵气。

**感官层叠：**
通过多种感官协同构建氛围，包括神识感知。每个细节都应该具体而有生活感。

示例：
洞府内弥漫着丹药和灵草的清香，神识扫过，能感受到周围灵气的流动脉络。空气中还夹杂着淡淡的血腥味，那是刚才激战留下的痕迹。神识探出，捕捉到远处隐约的杀机波动，让她不由自主地绷紧了身体。
...
核心原则：
- 使用全部五感，加上神识感知（灵觉）
- 具体细节优于笼统描写，包括灵气波动、修为境界等修仙元素
- 将感官和神识细节连接到角色情感
- 动作序列聚焦冲击力和运动，体现修炼者的战斗风格
- 环境反映和放大故事情绪，融入修仙世界的氛围
- 避免华丽辞藻 - 每个细节都必须服务网文故事
...
[DESCRIPTION_HALL_ATMOSPHERE]: 灵气在宗门大殿中如薄雾般萦绕，在古朴的玉石桌案上投下柔和的光芒。丹药的清香混合着淡淡的血腥味，神识扫过，能感受到周围弟子的修为波动，让她不由自主地提高了警惕。

[ACTION_CONFRONTATION]: 玉简在手中碎裂的声响在大殿中回荡，掌门猛地从玉座上站起。那声音像惊雷一样震撼了所有人的神魂，突然间大殿里每道神识都聚焦了过来。她的手不由自主地握上了储物戒，做好了战斗准备。

[DESCRIPTION_WEATHER]: 天地灵气在秘境中躁动不安，每一丝灵气都带着凌厉的杀机。秘境风暴来得很快，把这片洞天福地变成了充满危险的战场。

**错误示例（不要这样做）：**

❌ 以下是场景描写：
1. [DESCRIPTION_HALL] - 宗门大殿很暗

❌ 宗门大殿很有氛围。[DESCRIPTION_ATMOSPHERE] 空气中弥漫着灵气。
